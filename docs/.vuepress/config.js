...
module.exports = {
  ...
  // theme: require.resolve('../../vdoing'), // 使用本地主题 (先将vdoing主题文件下载到本地：https://github.com/ronnaces/ronna-codegen-doc)

  title: "ronna-codegen-doc",
  description: '一个基于VuePress的 知识管理&博客 主题',
  base: '/ronna-codegen-doc/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [ // 注入到页面<head> 中的标签，格式[tagName, { attrName: attrValue }, innerHTML?]
    ['link', { rel: 'icon', href: '/img/favicon.ico' }], //favicons，资源放在public文件夹
    ['meta', { name: 'keywords', content: 'vuepress,theme,blog,ronnace,ronna-codegen' }],
  ...
  themeConfig: {
    nav: [
      ...
      { text: '资源', link: '/pages/db78e2/' },
      {
        ...
        items: [
          {
            text: "Github日志",
            link: "https://github.com/ronnaces/ronna-codegen/releases",
          },
        ],
      },
      {
    ...
    repo: 'ronnaces/ronna-codegen-doc', // 导航栏右侧生成Github链接
